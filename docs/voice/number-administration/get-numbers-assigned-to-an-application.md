...
<a class="edit-on-github" href="https://github.com/sinch/docs/blob/master/docs/voice/number-administration/get-numbers-assigned-to-an-application.md">Edit on GitHub</a>