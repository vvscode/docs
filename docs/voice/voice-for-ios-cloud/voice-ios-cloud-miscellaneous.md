...
| Application Key      | A key generated by Sinch. The key uniquely identifies the Application. A key looks like `196087a1-e815-4bc4-8984-60d8d8a 43f1d` (lowercase hexadecimal formatted GUID).  |
