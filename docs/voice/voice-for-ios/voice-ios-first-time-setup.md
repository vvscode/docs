...
<a class="gitbutton pill" target="_blank" href="https://github.com/sinch/docs/blob/master/docs/voice/voice-for-ios/voice-ios-first-time-setup.md"><span class="fab fa-github"></span>Edit on GitHub!</a>