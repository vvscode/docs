...
The Sinch Verification SDK can be downloaded [here](doc:downloads). It contains: the library binary, this user guide, reference documentation, and sample apps.
