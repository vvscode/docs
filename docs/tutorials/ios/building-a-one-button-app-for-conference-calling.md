...
<a class="edit-on-github" href="https://github.com/sinch/docs/blob/master/docs/tutorials/ios/building-a-one-button-app-for-conference-calling.md">Edit on GitHub</a>