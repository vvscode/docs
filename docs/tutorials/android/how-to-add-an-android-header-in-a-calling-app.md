...
<a class="gitbutton pill" target="_blank" href="https://github.com/sinch/docs/blob/master/docs/tutorials/android/how-to-add-an-android-header-in-a-calling-app.md">
