...
> 2.  In the [developer dashboard](https://portal.sinch.com/), create a new app and take note of the app key and secret
> 3.  `Download <sinchvvvdownloads>` the Sinch JavaScript SDK
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a47b508-app.png",
        "app.png",
        251,
        341,
        "#efefef"
