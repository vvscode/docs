...
${this.content}`;
    ...
    replaceElement(element, replacementText) {
        return Page.create({
            ...this,
            sources: element.replace(this.sources, replacementText)
        });
    }
...
class Image extends Link {
    get markdown() {
        return `![${this.label}](${this.href})`;    // might need to support title as well
    }
}
