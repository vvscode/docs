const {XrefLink, UrlLink, MailtoLink, RemoteImage, LocalImage} = require('./catalog');
...
module.exports = {
    ...
    localimages: new LinkValidator(LocalImage),
    remoteimages: new LinkValidator(RemoteImage),
